...
if (isset($_POST['submit'])) {
    ...
    $from = "cf.oriol.carmona@torreroja.cat"; // Email con el dominio del Hosting para evitar SPAM
    $fromName = "RPF-WEB"; // Nombre que saldrá en el email recibido
    $to = "cf.oriol.carmona@torreroja.cat"; // Dirección donde se enviará el formulario
